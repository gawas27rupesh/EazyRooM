...
<div class="col-md-8 offset-md-4">
     <form action="postdeletetenant" method="post">
        <table cellspacing="15px" cellpadding="5px">
            <tr>
                <td><label for="contno">ENTER CONTACT NO:</label></td>
                <td><input type="tel" id="contno" name="contno" placeholder="Enter Number Only" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="hidden" id="utype" name="utype" value="tenant" required></td>
            </tr>
        </table>
        <div class="col-md-7 offset-md-1 mt-5">
            <a href="tenant" class="btn btn-outline-danger">GO BACK</a>
            <button type="submit" class="btn btn-outline-success">SEE POST</button>   
       </div>
     </form>
    </div>
</body>
