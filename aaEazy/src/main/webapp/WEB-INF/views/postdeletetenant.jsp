...
<head>
    ...
    <style>
	body{
	background-image:linear-gradient(rgba(1,1,1,.7),rgba(1,1,1,.7)),url('<c:url value="/resources/EazyRooM.jpg"/>');
  ...
  <tbody>
   <c:forEach items="${eazy }" var="e">
    ...
    <td>${e.utype }</td>
      ...
      <td>${e.address }</td>
      <td>
      <a href="deletetenant/${e.id }"><i class="fa-solid fa-trash text-danger" style="font-size:23px;"></i></a>
     <a href="updatetenant/${e.id }"><i class="fa-solid fa-pen-nib text-primary" style="font-size:23px;"></i></a>
